//Yunlu Li, yl4df, 2019-10-14, BinarySearchTree.h
#ifndef BST_H
#define BST_H
...
class BinarySearchTree {
 ...
 private:
  ...
  string pathTo_node(BinaryNode* n, const string& x) const;
  // private helper for find
  bool find_node(BinaryNode* n, const string& x) const;
  // private helper for rnumNodes
  int numNodes_node(BinaryNode* n) const;
