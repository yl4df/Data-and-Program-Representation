//Yunlu Li, yl4df, 2019-10-16, AVLTree.h
#ifndef AVL_H
#define AVL_H
...
class AVLTree {
 ...
 private:
  ...
  string pathTo_node(AVLNode* n, const string& x) const;
  // private helper for find
  bool find_node(AVLNode* n, const string& x) const;
  // private helper for rnumNodes
  int numNodes_node(AVLNode* n) const;
